...
p = plotter(number_of_samples=[1000, 200, 300, 400], total_plots=4, rows=2, cols=2, names=["Sensor do Centro", "Sensor da Direita", "Sensor da Esquerda", "Sensor de Baixo"], y_low_lim = 0, y_high_lim = 500)
data = []
